        ...
        for(i=0;i<=7;i++){
            ...
            if((icon1==icon2)&&(icon2==icon3)&&(icon1!=null)){
                if(icon1==ic1){
                    ...
                    if(type==true) {
                    	JOptionPane.showMessageDialog(TicTacToe.this,"Player2 won! Click reset");
                    }
                    else {
                    ...
                    if(type==true) {
                    	JOptionPane.showMessageDialog(TicTacToe.this,"Player1 won! Click reset");
                    }
                    else {
                    	JOptionPane.showMessageDialog(TicTacToe.this,"Computer won! Click reset");
                    }
                    break;
                }
            }
